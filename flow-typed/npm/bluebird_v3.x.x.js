...
declare type Bluebird$RangeError = Error;
declare type Bluebird$CancellationErrors = Error;
declare type Bluebird$TimeoutError = Error;
declare type Bluebird$RejectionError = Error;
declare type Bluebird$OperationalError = Error;
